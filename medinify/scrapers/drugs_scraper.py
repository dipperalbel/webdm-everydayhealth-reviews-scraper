...
class DrugsScraper(Scraper):
    ...
    def get_url(self, drug_name):
        ...
        reviews_url = ""
        #print(search_soup.findAll('p', {'class': 'user-reviews-title mgb-1'}))
        print(search_soup.find('p', {'class': 'user-reviews-title mgb-1'}).find('a'))
        if search_soup.find('p', {'class': 'user-reviews-title mgb-1'}):
            reviews_url = 'https://www.drugs.com'
            reviews_url =  reviews_url + search_soup.find(
